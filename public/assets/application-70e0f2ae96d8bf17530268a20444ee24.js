...
(function() {
  ...
  $(document).ready(function() {
    $(document).delegate("#new_webshot .new-webshot-submit", "click", function() {
      return $('#myModal').modal('show');
    });
    return $(document).delegate(".modal-dialog .share-by-email-submit", "click", function() {
      var data, datafrom, url;
      if (readyToGo === true) {
        readyToGo = false;
